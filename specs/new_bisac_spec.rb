...
context "A new bisac object" do
  ...
  setup do
    ...
    @valid_item2 = Bisac::Product.new("0975240277")
  ...
  specify "Should have product lines that are exactly 259 chars long" do
    bisac = Bisac::Message.new("Rainbow","1234567","test","1")
    bisac << @valid_item1
    bisac << @valid_item2
  ...
  specify "Should load a valid BISAC file from disk correctly" do
    msg = Bisac::Message.load(File.dirname(__FILE__) + "/data/valid_bisac.txt")
